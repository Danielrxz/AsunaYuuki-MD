...
let drm1 = ""
let drm2 = ""
let rtx = `☁️ *Vincula el Socket usando el código QR.*\n\nSigue las instrucciones:\n☘️ *Mas opciones › Dispositivos vinculados › Vincular un nuevo dispositivo › Escanea el código QR.*\n\n_Recuerda que es recomendable no usar tu cuenta principal para registrar un socket._\n↺ El codigo es valido por 60 segundos.`
let rtx2 = `☁️ *Vincula el Socket usando el código de 8 dígitos.*\n\nSigue las instrucciones:\n☘️ *Mas opciones › Dispositivos vinculados › Vincular un nuevo dispositivo › Vincular con el número de telefono › Introduce el código de 8 dígitos.*\n\n_Recuerda que es recomendable no usar tu cuenta principal para registrar un socket._\n↺ El codigo es valido por 60 segundos.`
...
await conn.sendMessage(m.chat, {text: `🌱 Vinculaste con éxito un nuevo *socket*` }, { quoted: m })
