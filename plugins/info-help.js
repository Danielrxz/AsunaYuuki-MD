...
let handler = async (m, { conn, args, usedPrefix }) => { 
  try {
    ...
    let now = new Date()
    let colombianTime = new Date(now.toLocaleString('en-US', { timeZone: 'America/Baja California Sur' }))
...
fileName: '^0.0.9 | Yuukibot 🌿',
mimetype: "https://files.catbox.moe/vmyuv5.jpg",
fileLength: '0',
pageCount: '1',
caption: menu.trim(),
contextInfo: {
