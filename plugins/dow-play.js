...
const handler = async (m, { conn, text, command }) => {
  try {
    if (!text.trim()) {
      return conn.reply(m.chat, `☁️ Por favor, Ingresa en nombre de la musica o enlace.`, m);
    }
    ...
    if (!esURL) {
      ...
      const infoMessage = `˚∩　ׅ　DESCARGAS ASUNA YUUKI 🌸　ׄᰙ　ׅ

> 🕸̴𖫲᮫ִ۫𝆬  Descargando › *${title}*

𖣣ֶㅤ֯⌗ ☁️ ׄ ⬭ Canal › *${canal}*
